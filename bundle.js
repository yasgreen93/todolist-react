...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoListApp = __webpack_require__(1);
	...
	var _CompleteTodoButton = __webpack_require__(171);

	var _CompleteTodoButton2 = _interopRequireDefault(_CompleteTodoButton);

	var _CompleteTodo = __webpack_require__(172);

	var _CompleteTodo2 = _interopRequireDefault(_CompleteTodo);

	var _SingleTodo = __webpack_require__(173);

	var _SingleTodo2 = _interopRequireDefault(_SingleTodo);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	ReactDOM.render(React.createElement(_TodoListApp2.default, { url: '/api/todos', updateUrl: '/api/todos/update', pollInterval: 2000 }), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoListApp = _react2.default.createClass({
	  ...
	  handleTodoUpdate: function handleTodoUpdate(id) {
	    var todos = this.state.data;
	    $.ajax({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(AddTodo, { onTodoSubmit: this.handleTodoSubmit }),
	      _react2.default.createElement(TodoList, { data: this.state.data, onTodoUpdate: this.handleTodoUpdate })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddTodo = _react2.default.createClass({
	  ...
	  handleTagChange: function handleTagChange(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CompleteTodoButton = _react2.default.createClass({
	  displayName: 'CompleteTodoButton',
	  ...
	  render: function render() {
	    ...
	    if (completed === false) {
	      button = _react2.default.createElement(CompleteTodo, { todo: todo, onTodoUpdate: update });
	    }
	    return _react2.default.createElement(
	      'span',
	      null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CompleteTodo = _react2.default.createClass({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SingleTodo = _react2.default.createClass({
	  displayName: 'SingleTodo',

	  render: function render() {
	    var update = this.props.onTodoUpdate;
	    var todo = this.props.todo;
	    var checkCompleted = function checkCompleted(todo) {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { id: 'liButton' },
	        _react2.default.createElement(CompleteTodoButton, { todo: todo, onTodoUpdate: update })
	      )
	    );
	  }
	});
